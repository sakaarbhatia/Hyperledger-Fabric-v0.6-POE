...
var transactionService =  require('services/rest/transaction-rest.service');
...
////Api for deploying chaincode : Accepts "address" body param of chaincode storage like on github
function deploy(req, res, next) {
  transactionService.deployChaincode(req)
    .then(function(data){
      res.send(data);
    })
    .catch(function(err){
